...
public class BuildLaptopDatabase {
    ...
    public static final String Q_Create=
            "CREATE TABLE "+DB_Table+"("+KEY_ID+" INTEGER PRIMARY KEY  AUTOINCREMENT,"+ScreenSize+" TEXT,"+Display+" TEXT,"+ScreenType+" TEXT,"+Processor+" TEXT, "+ProcessorGen+" TEXT, "+RAM+" TEXT, "+Storage+" TEXT, "+GraphicCard+" TEXT)";
    ...
    public void save(String screenSize,String display,String screenType,
                     ...
                     String storage,String graphicCard) {
    ...
    public List<BuildLaptop> getBuildLaptopData()
    {
        ...
        String[] columns={KEY_ID,ScreenSize,Display,ScreenType,Processor,ProcessorGen,RAM,Storage,GraphicCard};
