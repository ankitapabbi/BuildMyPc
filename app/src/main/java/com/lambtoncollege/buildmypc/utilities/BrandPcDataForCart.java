...
public class BrandPcDataForCart {

    public static final String DB_Name="brandpcforcart.db";
    ...
    Context c;
    private BrandPcDataForCart.DBHelper dbHelper;
    private SQLiteDatabase database;

    //all database operation coded here
    public BrandPcDataForCart(Context context){
        c = context;

    }

    public BrandPcDataForCart open() {

        dbHelper=new BrandPcDataForCart.DBHelper(c);
