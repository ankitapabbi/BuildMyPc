...
public class AccessoriesDatabaseForCart {

    public static final String DB_Name="accessoriesforcart.db";
    ...
    Context c;
    private AccessoriesDatabaseForCart.DBHelper dbHelper;
    private SQLiteDatabase database;

    //all database operation coded here
    public AccessoriesDatabaseForCart(Context context){
        c = context;

    }

    public AccessoriesDatabaseForCart open() {

        dbHelper=new AccessoriesDatabaseForCart.DBHelper(c);
